...
subroutine read_rpmd_traj(i, hist, udebug)
    ...
    outer: do
        ...
        do j = 1, nb
            ...
            l1 = 0
            l2 = 0
            l1 = l1 + (r(ind(1), 1) - r(ind(2), 1)) ** 2
            l1 = l1 + (r(ind(1), 2) - r(ind(2), 2)) ** 2
            l1 = l1 + (r(ind(1), 3) - r(ind(2), 3)) ** 2
            l2 = l2 + (r(ind(3), 1) - r(ind(2), 1)) ** 2
            l2 = l2 + (r(ind(3), 2) - r(ind(2), 2)) ** 2
            l2 = l2 + (r(ind(3), 3) - r(ind(2), 3)) ** 2
